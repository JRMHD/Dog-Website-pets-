                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 text-center">
                        <div class="banner-section-content">
                            ...
                            <p data-aos="fade-right" style="font-size: 16px;">Expert tips on dog care, training advice,
                                and pet health insights from Gibmarnel's professionals.</p>
                        ...
                        <div class="row position-relative">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="store_box">
                                    <div class="store_image_box">
                                        <figure class="mb-0">
                                            <img src="assets/images/our_store_image5.png" alt=""
                                                class="img-fluid">
                                        </figure>
                                        <i class="fa-regular fa-heart"></i>
                                    </div>
                                    <div class="store_box_content">
                                        <div class="text_rate_wrapper">
                                            <div class="text_wrapper">
                                                <h5>Stella & Chewy’s Wild weenies </h5>
                                                <p class="text-size-16">Adultos</p>
                                            </div>
                                            <div class="rating">
                                                <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="store_box box6">
                                    <div class="store_image_box">
                                        <figure class="mb-0">
                                            <img src="assets/images/our_store_image6.png" alt=""
                                                class="img-fluid">
                                        </figure>
                                        <i class="fa-regular fa-heart"></i>
                                    </div>
                                    <div class="store_box_content">
                                        <div class="text_rate_wrapper">
                                            <div class="text_wrapper">
                                                <h5>ACANA Singles Grain Free </h5>
                                                <p class="text-size-16">Adultos</p>
                                            </div>
                                            <div class="rating">
                                                <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="store_box">
                                    <div class="store_image_box">
                                        <figure class="mb-0">
                                            <img src="assets/images/our_store_image7.png" alt=""
                                                class="img-fluid">
                                        </figure>
                                        <i class="fa-regular fa-heart"></i>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                <div class="store_box box8">
                                    <div class="store_image_box">
                                        <figure class="mb-0">
                                            <img src="assets/images/our_store_image8.png" alt=""
                                                class="img-fluid">
                                        </figure>
                                        <i class="fa-regular fa-heart"></i>
                                    </div>
                                    <div class="store_box_content">
                                        <div class="text_rate_wrapper">
                                            <div class="text_wrapper">
                                                <h5>Bocce’s Bakery Every Day</h5>
                                                <p class="text-size-16">Adultos</p>
                                            </div>
                                            <div class="rating">
                                                <i class="fa-solid fa-star"></i>
