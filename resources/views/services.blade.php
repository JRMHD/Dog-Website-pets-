            ...
            <div class="row position-relative">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="register_images">
                        <figure class="register_packet_image mb-0">
                            <img src="assets/images/register_packet_image.png" alt="" class="img-fluid">
                        </figure>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                ...
                <figure class="mb-0 register_big_foot_shape position-absolute left_right_shape">
                    <img src="assets/images/register_big_foot.png" alt="" class="img-fluid">
                </figure>
                <figure class="mb-0 register_small_foot_shape position-absolute left_right_shape">
                    <img src="assets/images/register_small_foot.png" alt="" class="img-fluid">
                </figure>
            </div>
            <figure class="mb-0 register_left_shape position-absolute top_bottom_shape">
                <img src="assets/images/register_left_shape.png" alt="" class="img-fluid">
            </figure>
            <figure class="mb-0 register_right_shape position-absolute top_bottom_shape">
                <img src="assets/images/register_dog.png" alt="" class="img-fluid">
            </figure>
        </div>
    </section>
