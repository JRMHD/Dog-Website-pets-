        ...
        <section class="banner-section">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                        <div class="banner-section-image position-relative">
                            ...
                            <div class="box pet_training_box position-absolute hover-effect">
                                <figure class="mb-0">
                                    <img src="assets/images/banner_pet_training_dog.png" alt=""
                                        class="img-fluid hover-effect">
                                </figure>
                                <div class="box_content_wrapper">
                            ...
                            <div class="box satisfied_client_box position-absolute hover-effect">
                                <div class="image_wrapper">
                                    <figure class="satisfied_client1 mb-0">
                                        <img src="assets/images/banner_satisfied_client1.png" alt=""
                                            class="img-fluid hover-effect">
                                    </figure>
                                    <figure class="satisfied_client2 mb-0">
                                        <img src="assets/images/banner_satisfied_client2.png" alt=""
                                            class="img-fluid hover-effect">
                                    </figure>
                                    <figure class="satisfied_client3 mb-0">
                                        <img src="assets/images/banner_satisfied_client3.png" alt=""
                                            class="img-fluid hover-effect">
                                    </figure>
                                </div>
                                <div class="box_content_wrapper">
                ...
                <figure class="banner_left_shape mb-0 position-absolute top_bottom_shape">
                    <img src="assets/images/banner_bottom_shape.png" alt="" class="img-fluid">
                </figure>
                <figure class="banner_right_shape mb-0 position-absolute top_bottom_shape">
                    <img src="assets/images/banner_top_shape.png" alt="" class="img-fluid">
                </figure>
            </div>
        </section>
    </div>
        ...
        <div class="container">
            ...
            <div class="row position-relative" data-aos="fade-up">
                ...
                <figure class="mb-0 services_box_shape position-absolute left_right_shape">
                    <img src="assets/images/services_box_left_shape.png" alt="" class="img-fluid">
                </figure>
            </div>
            <figure class="mb-0 services_left_shape position-absolute top_bottom_shape">
                <img src="assets/images/services_dog_shape.png" alt="" class="img-fluid">
            </figure>
            <figure class="mb-0 services_right_shape position-absolute top_bottom_shape">
                <img src="assets/images/services_cat_shape.png" alt="" class="img-fluid">
            </figure>
        </div>
    </section>
    <!-- ABOUT US SECTION -->
