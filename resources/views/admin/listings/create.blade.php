                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                        <div>
                            ...
                            <p style="color: #6B7280; font-size: 1rem;">Add a new dog or product to your listings</p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="type" name="type" required onchange="toggleFields()"
                                        ...
                                        <option value="dog" {{ old('type') === 'dog' ? 'selected' : '' }}>Dog for Sale
                                        </option>
                                        <option value="product" {{ old('type') === 'product' ? 'selected' : '' }}>Dog
                                            Product</option>
                                    </select>
                                    @error('type')
                        ...
                        <div style="margin-bottom: 32px;">
                            ...
                            <div style="margin-bottom: 16px;">
                                ...
                                <textarea id="description" name="description" rows="4" required
                                    ...
                                    onfocus="this.style.borderColor='#5260DE'; this.style.backgroundColor='white'; this.style.boxShadow='0 0 0 3px rgba(82, 96, 222, 0.1)'"
                                    onblur="this.style.borderColor='{{ $errors->has('description') ? '#EF4444' : '#e5e7eb' }}'; this.style.backgroundColor='#f9fafb'; this.style.boxShadow='none'">{{ old('description') }}</textarea>
                                @error('description')
                                    <div style="color: #EF4444; font-size: 14px; margin-top: 4px;">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div style="color: #6B7280; font-size: 14px; margin-top: 4px;">You can select multiple
                                        images. Max 2MB per image.</div>
                                    @error('images.*')
                                        <div style="color: #EF4444; font-size: 14px; margin-top: 4px;">{{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div style="border-top: 2px solid #e5e7eb; padding-top: 32px;">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="text" id="health_status" name="health_status"
                                            value="{{ old('health_status') }}" placeholder="e.g., Healthy, Special Needs"
                                ...
                                <div>
                                    ...
                                    <textarea id="temperament" name="temperament" rows="3"
                                        ...
                                        onfocus="this.style.borderColor='#5260DE'; this.style.backgroundColor='white'; this.style.boxShadow='0 0 0 3px rgba(82, 96, 222, 0.1)'"
                                        onblur="this.style.borderColor='{{ $errors->has('temperament') ? '#EF4444' : '#e5e7eb' }}'; this.style.backgroundColor='#f9fafb'; this.style.boxShadow='none'">{{ old('temperament') }}</textarea>
                                    @error('temperament')
                                        <div style="color: #EF4444; font-size: 14px; margin-top: 4px;">{{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div style="border-top: 2px solid #e5e7eb; padding-top: 32px;">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <select id="category" name="category"
                                            ...
                                            <option value="Toy" {{ old('category') === 'Toy' ? 'selected' : '' }}>Toy
                                            </option>
                                            <option value="Accessory"
                                                {{ old('category') === 'Accessory' ? 'selected' : '' }}>Accessory</option>
                                            <option value="Health" {{ old('category') === 'Health' ? 'selected' : '' }}>
                                                Health</option>
                                            <option value="Training"
                                                {{ old('category') === 'Training' ? 'selected' : '' }}>Training</option>
                                            <option value="Grooming"
                                                {{ old('category') === 'Grooming' ? 'selected' : '' }}>Grooming</option>
                                        </select>
                                        @error('category')
                                            <div style="color: #EF4444; font-size: 14px; margin-top: 4px;">{{ $message }}
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="subcategory" name="subcategory"
                                            value="{{ old('subcategory') }}" placeholder="e.g., Puppy Food, Chew Toy"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <select id="suitable_for" name="suitable_for"
                                            ...
                                            <option value="Puppy"
                                                {{ old('suitable_for') === 'Puppy' ? 'selected' : '' }}>Puppy</option>
                                            <option value="Adult Dog"
                                                {{ old('suitable_for') === 'Adult Dog' ? 'selected' : '' }}>Adult Dog
                                            </option>
                                            <option value="Senior Dog"
                                                {{ old('suitable_for') === 'Senior Dog' ? 'selected' : '' }}>Senior Dog
                                            </option>
                                            <option value="All Ages"
                                                {{ old('suitable_for') === 'All Ages' ? 'selected' : '' }}>All Ages
                                            </option>
                                        </select>
                                        @error('suitable_for')
                                            <div style="color: #EF4444; font-size: 14px; margin-top: 4px;">{{ $message }}
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="weight_or_size" name="weight_or_size"
                                            value="{{ old('weight_or_size') }}" placeholder="e.g., 2kg, Medium, 30cm"
                                ...
                                <div>
                                    ...
                                    <textarea id="ingredients" name="ingredients" rows="3"
                                        ...
                                        onfocus="this.style.borderColor='#5260DE'; this.style.backgroundColor='white'; this.style.boxShadow='0 0 0 3px rgba(82, 96, 222, 0.1)'"
                                        onblur="this.style.borderColor='{{ $errors->has('ingredients') ? '#EF4444' : '#e5e7eb' }}'; this.style.backgroundColor='#f9fafb'; this.style.boxShadow='none'">{{ old('ingredients') }}</textarea>
                                    @error('ingredients')
                                        <div style="color: #EF4444; font-size: 14px; margin-top: 4px;">{{ $message }}
                                        </div>
                                    @enderror
